...
Action[ACTION_CONST_SHAMAN_ENCHANCEMENT] = {
    ...
    -- Potions
    PotionofUnbridledFury                  = Create({ Type = "Potion", ID = 169299, Hidden = true,  QueueForbidden = true }), 
    SuperiorPotionofUnbridledFury          = Create({ Type = "Potion", ID = 168489, Hidden = true,  QueueForbidden = true }), 
