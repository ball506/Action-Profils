...
local TheActionHelper = TheActionHelper
...
local function CreateAnchorFrame()
    ...
    local r, g, b = TheActionHelper:BackgroundColors("normal")
    anchorFrame:SetBackdropColor(r, g, b, TheActionHelper:Opacity())
    ...
    local icon_size = TheActionHelper:IconSize()
    ...
    title:SetTextColor(TheActionHelper:TitleColors("normal"))
    ...
    text:SetText(L[Drag_to_set_the_spawn_point_for_toasts])
    text:SetTextColor(TheActionHelper:TextColors("normal"))
    ...
    return {
        ...
        func = function()
            if not preview_registered then
                LibToast:Register("TheActionHelperPreview", function(toast, ...)
            ...
            LibToast:Spawn("TheActionHelperPreview", reference)
        end,
    }
end
    ...
    defaultOptions = {
        ...
        args = {
            ...
            x = {
                ...
                type = "input",
                name = L[X_Offset],
                desc = L[Horizontal_offset_from_the_anchor_point],
                get = function()
            ...
            y = {
                ...
                type = "input",
                name = L[Y_Offset],
                desc = L[Vertical_offset_from_the_anchor_point],
                get = function()
...
function TheActionHelper:SetupOptions()
    db = private.db
...
function TheActionHelper:UpdateAddOnOptions()
