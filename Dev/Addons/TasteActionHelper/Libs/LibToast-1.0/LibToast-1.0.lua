...
local DEFAULT_OS_SPAWN_POINT = "CENTER" --_G.IsMacClient() and "TOPRIGHT" or "BOTTOMRIGHT"
...
local function _acquireToast(addonName)
    ...
    if not toast then
        ...
        local text = toast:CreateFontString(nil, "BORDER", "FriendsFont_Large")
...
function ToastProxy:SetTextFont(font, size)
    CurrentToast.text:SetFont(font, size)
end
