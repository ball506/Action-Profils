...
A[3] = function(icon, isMulti)
    ...
    local function EnemyRotation(unit)
        ...
        local function BuildAShard(unit)
            ...
            if A.SoulStrike:IsReady(unit) and (not A.DemonicConsumption:IsSpellLearned() or Unit("player"):CombatTime() > 15 or Player:PrevGCDP(1, A.HandofGuldan) and not Unit("player"):HasHeroism) then
        ...
        local function Implosion(unit)
            ...
            if A.Implosion:IsReady(unit) and ((Unit("player"):HasBuffsStacks(A.WildImpsBuff.ID, true) >= 6 and (Player:SoulShardsP < 3 or Player:PrevGCDP(1, A.CallDreadstalkers) or Unit("player"):HasBuffsStacks(A.WildImpsBuff.ID, true) >= 9 or Player:PrevGCDP(1, A.BilescourgeBombers) or (not Player:PrevGCDP(1, A.HandofGuldan) and not Player:PrevGCDP(2, A.HandofGuldan))) and not Player:PrevGCDP(1, A.HandofGuldan) and not Player:PrevGCDP(2, A.HandofGuldan) and Unit("player"):HasBuffsDown(A.DemonicPowerBuff.ID, true)) or (Unit(unit):TimeToDie() < 3 and Unit("player"):HasBuffsStacks(A.WildImpsBuff.ID, true) > 0) or (Player:PrevGCDP(2, A.CallDreadstalkers) and Unit("player"):HasBuffsStacks(A.WildImpsBuff.ID, true) > 2 and not A.DemonicCalling:IsSpellLearned())) then
            ...
            if A.HandofGuldan:IsReady(unit) and (Player:SoulShardsP >= 3 and (((Player:PrevGCDP(2, A.HandofGuldan) or Unit("player"):HasBuffsStacks(A.WildImpsBuff.ID, true) >= 3) and Unit("player"):HasBuffsStacks(A.WildImpsBuff.ID, true) < 9) or A.SummonDemonicTyrant:GetCooldown() <= GetGCD() * 2 or Unit("player"):HasBuffs(A.DemonicPowerBuff.ID, true) > GetGCD() * 2)) then
                return A.HandofGuldan:Show(icon)
            end
            ...
            if A.Demonbolt:IsReady(unit) and (Player:PrevGCDP(1, A.HandofGuldan) and Player:SoulShardsP >= 1 and (Unit("player"):HasBuffsStacks(A.WildImpsBuff.ID, true) <= 3 or Player:PrevGCDP(3, A.HandofGuldan)) and Player:SoulShardsP < 4 and Unit("player"):HasBuffs(A.DemonicCoreBuff.ID, true)) then
                return A.Demonbolt:Show(icon)
            end
        ...
        local function Opener(unit)
            ...
            if A.HandofGuldan:IsReady(unit) and (Player:PrevGCDP(1, A.HandofGuldan) and Player:SoulShardsP > 0 and Player:PrevGCDP(2, A.SoulStrike)) then
                return A.HandofGuldan:Show(icon)
            end
            ...
            if A.DemonicStrength:IsReady(unit) and (Player:PrevGCDP(1, A.HandofGuldan) and not Player:PrevGCDP(2, A.HandofGuldan) and (Unit("player"):HasBuffsStacks(A.WildImpsBuff.ID, true) > 1 and A.HandofGuldan:IsSpellInFlight())) then
            ...
            if A.SoulStrike:IsReady(unit) and (not Unit("player"):HasHeroism or Unit("player"):CombatTime() > 5 and Player:PrevGCDP(1, A.HandofGuldan)) then
                return A.SoulStrike:Show(icon)
            end
            ...
            if A.HandofGuldan:IsReady(unit) and (Player:SoulShardsP >= 3 and Player:PrevGCDP(2, A.HandofGuldan) and Unit("player"):CombatTime() > 5 and (Player:PrevGCDP(1, A.SoulStrike) or not A.SoulStrike:IsSpellLearned() and Player:PrevGCDP(1, A.ShadowBolt))) then
                return A.HandofGuldan:Show(icon)
            end
            ...
            if A.SummonDemonicTyrant:IsReady(unit) and (Player:PrevGCDP(1, A.DemonicStrength) or Player:PrevGCDP(1, A.HandofGuldan) and Player:PrevGCDP(2, A.HandofGuldan) or not A.DemonicStrength:IsSpellLearned() and Unit("player"):HasBuffsStacks(A.WildImpsBuff.ID, true) + imps_spawned_during.2000 / Player:SpellHaste() >= 6) then
                return A.SummonDemonicTyrant:Show(icon)
            end
  ...
  if Precombat(unit) then
    return true
        ...
        if inCombat and Unit(unit):IsExists() then
            ...
            if A.HandofGuldan:IsReady(unit) and (A.ExplosivePotential:GetAzeriteRank() and Unit("player"):CombatTime() < 5 and Player:SoulShardsP > 2 and Unit("player"):HasBuffsDown(A.ExplosivePotentialBuff.ID, true) and Unit("player"):HasBuffsStacks(A.WildImpsBuff.ID, true) < 3 and not Player:PrevGCDP(1, A.HandofGuldan) and true and not Player:PrevGCDP(2, A.HandofGuldan)) then
                return A.HandofGuldan:Show(icon)
            end
            ...
            if A.HandofGuldan:IsReady(unit) and ((A.BalefulInvocation:GetAzeriteRank() > 0 or A.DemonicConsumption:IsSpellLearned()) and Player:PrevGCDP(1, A.HandofGuldan) and A.SummonDemonicTyrant:GetCooldown() < 2) then
                return A.HandofGuldan:Show(icon)
            end
