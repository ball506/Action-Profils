...
A[3] = function(icon, isMulti)
    ...
    local function EnemyRotation(unit)
        ...
        local function NetherPortalBuilding(unit)
            ...
            if A.PowerSiphon:IsReady(unit) and (Unit("player"):CombatTime >= 30 and Unit("player"):HasBuffsStacks(A.WildImpsBuff) >= 2 and Unit("player"):HasBuffsStacks(A.DemonicCoreBuff) <= 2 and bool(Unit("player"):HasBuffsDown(A.DemonicPowerBuff)) and Unit("player"):SoulShardsP >= 3) then
