...
A[3] = function(icon, isMulti)
    ...
    local function EnemyRotation(unit)
        ...
        local function St(unit)
            ...
            if A.ArcaneShot:IsReady(unit) and (Unit("player"):Focus() > 60 and not A.SteadyFocus:IsSpellLearned() or Unit("player"):HasBuffs(A.PreciseShotsBuff) and bool(Unit("player"):HasBuffsDown(A.TrueshotBuff)) or Unit("player"):Focus() > 85) then
                return A.ArcaneShot:Show(icon)
            end
            -- steady_shot
