...
local function EvaluateTargetIfBlackoutKick622(unit)
  return (A.FistsofFury:GetCooldown() < 3 and Player:Chi() == 2 or Player:EnergyTimeToMaxPredicted() < 1) and (Player:PrevGCDP(1, A.TigerPalm) or Player:ChiMax() - Player:Chi() < 2)
end
