...
A[3] = function(icon, isMulti)
    ...
    local function EnemyRotation(unit)
        ...
        local function Cooldown(unit)
            ...
            if A.Metamorphosis:IsReady(unit) and (A.Demonic:IsSpellLearned() and (not A.ChaoticTransformation:GetAzeriteRank() or (A.EyeBeam:GetCooldown() > 20 and A.BladeDance:GetCooldown() > A.GetGCD()))) then
                return A.Metamorphosis:Show(icon)
            end
