...
A[3] = function(icon, isMulti)
   ...
   Everyone.AoEToggleEnemiesUpdate()
    ...
    if (Player:ComboPointsDeficit() <= 1 - num((A.DeeperStratagem:IsSpellLearned() and (Unit("player"):HasBuffs(A.VanishBuff) or A.TheFirstDance:GetAzeriteRank and not A.DarkShadow:IsSpellLearned() and not A.Subterfuge:IsSpellLearned())))) then
